...
# Settings (1 = true, 0 = false, 2 = windows crashing)
...
scoreboard objectives add Harder_Settings_DisableXaeroRadarOnHarderMode dummy
scoreboard players set World Harder_Settings_DisableXaeroRadarOnHarderMode 1
...
tellraw @a [{"text":"  • Disable Xaero Entity Radar: ","color":"gray"},{"score":{"name":"World","objective":"Harder_Settings_DisableXaeroRadarOnHarderMode"},"color":"yellow","clickEvent":{"action":"suggest_command","value":"/scoreboard players set World Harder_Settings_DisableXaeroRadarOnHarderMode "}}]
